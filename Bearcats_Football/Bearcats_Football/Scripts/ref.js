...
function loadChildren(name, silent, callback) {
    ...
    var isObject = /[A-Z]/.test(name[0]),
		url = isObject ?
            ...
            "http ://api.highcharts.com/object/highcharts-obj/child" :
			"http ://api.highcharts.com/object/highcharts-obj/child",
...
buildPage = function () {
    ...
    $.ajax({
        type: "GET",
        url: 'http://api.highcharts.com/option/highcharts/main',
        async: false,
        dataType: "json",
        success: function (data) {
            $.each(data, function (key, val) {
    ...
    $.ajax({
        ...
        url: "http://api.highcharts.com/object/highcharts-obj/main",
        async: false,
        dataType: "json",
...
$(document).ready(function () {
    ...
    if (runDB) {
        ...
        prepareOffline(function () {
            // load offline data
            loadScript('./content/api/' + PRODUCTNAME + '.json', function () {
